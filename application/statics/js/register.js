...
const VUE = new Vue({
	...
	methods: {
		...
		signupFormSubmit: function(e){
			...
			this.$http.post('/api/signup', { name:this.form.user.name, password: this.form.user.password, confirmPassword: this.form.user.confirmPassword, email: this.form.user.email }).then(res=>{
				console.log(res)
